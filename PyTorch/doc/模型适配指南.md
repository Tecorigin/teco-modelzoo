...
--------------+------------------------------------------------
(torch_env) root@DevGen03:/softwares# teco-smi                    //查看太初AI加速卡的硬件信息（teco-smi -c 可以查看具体核组占用）
...
- **算子仓库**：`https://github.com/tecorigin-caet/Tecorigin-CAET/teco-ops-{队名}`
- **模型仓库**：`https://github.com/tecorigin-caet/Tecorigin-CAET/teco-modelzoo-{队名}`
  
队长通过邮箱接受邀请后获得仓库权限，后续由队长负责添加队员。各队伍在私有仓库下进行开发。
```bash
git clone https://github.com/tecorigin-caet/Tecorigin-CAET/teco-ops-{队名}
git clone https://github.com/tecorigin-caet/Tecorigin-CAET/teco-modelzoo-{队名}
```

本次赛事需要适配的小模型源码仓库：https://github.com/Tecorigin/Deformable-DETR （模型细节要求见该仓库）
